...
class CaloriesFormPage(MethodView):
    ...
    def post(self):
        ...
        temperature = Temperature(website='https://www.timeanddate.com/weather/', country=calories_form.country.data, city=calories_form.city.data).get()
...
class CaloriesForm(Form):
    ...
    city = StringField("City: ", default='milan')
